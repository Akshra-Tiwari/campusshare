...
import { getAllUsers, getResources, deleteResource, updateUserProfile } from '../services/firestore';
...
export default function AdminPage() {
  ...
  const loadData = async () => {
    setLoading(true);
    try {
      const [{ resources: res }, allUsers] = await Promise.all([
        getResources({}, 100),
        getAllUsers(),
      ]);
      setResources(res);
